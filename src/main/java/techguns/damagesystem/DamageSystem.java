        ...
        else
        {
            ...
            else
            {
                ...
                if (ent.getHealth() <= 0.0F)
                {
                    ...
                    {
                        SoundEvent soundevent = (SoundEvent)ELB_getDeathSound.invoke(ent);

                        if (flag1 && soundevent != null)
                        {
                            ent.playSound(soundevent, (float)ELB_getSoundVolume.invoke(ent), (float)ELB_getSoundPitch.invoke(ent));
                        }
