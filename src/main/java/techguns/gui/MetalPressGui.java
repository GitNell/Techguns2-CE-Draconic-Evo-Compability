...
public class MetalPressGui extends PoweredTileEntGui {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        String s2 = switch (this.tile.getAutoSplitMode()) {
            case 0 -> TextFormatting.RED + TextUtil.trans("techguns.container.info.off");
            case 1 -> TextFormatting.GREEN + TextUtil.trans("techguns.container.info.on");
            default -> "";
        };
